...
public class HardDisksApplet extends Applet implements ActionListener, Runnable {
   ...
   public void movimiento() {
      ...
      for(int var37 = 0; var37 < this.N; ++var37) {
         double[] var10000;
         for(int var38 = var37 + 1; var38 < this.N; ++var38) {
            double var21 = 0.5D;
            double var5 = this.velx[var37] - this.velx[var38];
            double var7 = this.vely[var37] - this.vely[var38];
            double var11 = var5 * var5 + var7 * var7;
            double var1 = this.posx[var38] - this.posx[var37];
            double var3 = this.posy[var38] - this.posy[var37];
            ...
            if (var29 > 0.0D) {
               ...
               if (var23 * var23 < 1.0D && var25 >= 0.0D && var25 < 1.0D) {
                  var10000 = this.posx;
                  var10000[var37] += var25 * this.velx[var37];
                  var10000 = this.posy;
                  var10000[var37] += var25 * this.vely[var37];
                  var10000 = this.posx;
                  ...
                  double var13 = var21 * (this.velx[var37] + this.velx[var38]);
                  double var15 = var21 * (this.vely[var37] + this.vely[var38]);
                  double var17 = var21 * var9 * var31;
                  double var19 = var21 * var9 * var33;
                  this.velx[var37] = var17 + var13;
                  this.vely[var37] = var19 + var15;
         ...
         var10000 = this.posx;
         var10000[var37] += this.velx[var37];
         var10000 = this.posy;
         var10000[var37] += this.vely[var37];
         if (this.posx[var37] < (double)(this.paredx + this.radio)) {
            this.posx[var37] = (double)(2 * (this.radio + this.paredx)) - this.posx[var37];
            var10000 = this.velx;
            var10000[var37] *= -1.0D;
         }

         if (this.posy[var37] < (double)(this.paredy + this.radio)) {
            this.posy[var37] = (double)(2 * (this.radio + this.paredy)) - this.posy[var37];
            var10000 = this.vely;
            var10000[var37] *= -1.0D;
         }

         if (this.posx[var37] > (double)(this.anchura - (this.radio + this.paredx))) {
            this.posx[var37] = (double)(2 * (this.anchura - this.paredx - this.radio)) - this.posx[var37];
            var10000 = this.velx;
            var10000[var37] *= -1.0D;
         }

         if (this.posy[var37] > (double)(this.altura - (this.radio + this.paredy))) {
            this.posy[var37] = (double)(2 * (this.altura - this.paredy - this.radio)) - this.posy[var37];
            var10000 = this.vely;
            var10000[var37] *= -1.0D;
         }

         if (this.posx[var37] > (double)(this.anchura / 2)) {
            ++this.Ndcha;
         } else {
            ++this.Nizda;
         }
